...
echo "⚙️ جاري إلغاء الميزات السحابية وتفعيل نظام التحديات المحلي بالكامل..."

# 1. تحديث شاشة المتصدرين لتكون محلياً بالكامل مع محاكاة المنافسين (lib/screens/leaderboard_screen.dart)
cat << 'FILE_LEADERBOARD' > lib/screens/leaderboard_screen.dart
...
echo "✅ تم تفعيل المحرك المحلي دون أي معتمدة سحابية!"
